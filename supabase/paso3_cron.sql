-- Centro de Mando Redes — paso 3: cron diario que llama a sonyc-youtube
-- Pegar en el SQL Editor del dashboard DESPUÉS de desplegar la función sonyc-youtube
...
select cron.schedule(
  'sonyc-youtube-diario',
  '0 5 * * *',
  $$
  select net.http_post(
    url := 'https://hahszmdfblcvljzanvoq.supabase.co/functions/v1/sonyc-youtube',
...
-- Comprobación (ejecutar aparte): debe salir una fila con jobname = sonyc-youtube-diario
